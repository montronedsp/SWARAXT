...
cp -a "${build_dir}/VST3/Swara XT.vst3" "${stage_dir}/VST3/Swara XT.vst3"
cp -a "${build_dir}/Standalone/Swara XT" "${stage_dir}/Standalone/Swara XT"
...
cp "${source_dir}/COPYRIGHT" "${stage_dir}/COPYRIGHT.txt"
